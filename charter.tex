...
Los datos utilizados en este proyecto contienen identificadores únicos y direcciones de correo electrónico de usuarios. Se tomaron medidas de pseudonimización para evitar la exposición de información sensible, eliminando o codificando los datos identificables. El acceso a la información fue otorgado por la empresa cliente, y su uso se restringe exclusivamente a fines académicos y de desarrollo, en cumplimiento con la Ley 25.326 de Protección de Datos Personales en Argentina.
